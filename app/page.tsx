...
const features = [
  ...
  },
  {
    name: "Cloud Backup",
    description:
      "Rest assured knowing your documents are safely backed up on the cloud, proctected from loss or damage.",
    icon: ServerCogIcon,
  },
  {
...
export default function Home() {
  return (
    <main className="min-h-screen h-screen flex-1 p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-600">
      <div className="bg-white px-4 py-24 sm:py-32 rounded drop-shadow-xl">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              enhancing profuctivity 10x fold effortlessly.
            </p>
          </div>
          <Button
            variant={"default"}
            asChild
            className="mt-10 bg-gray-800 text-white rounded shadow-md hover:bg-gray-700 hover:text-white transition duration-300"
          >
        ...
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div aria-hidden="true" className="relative">
              <div className="absolute bottom-0 bg-gradient-to-t from-white/95 pt-[5%] -inset-x-32" />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
            {features.map((feature, idx) => (
              <div className="relative pl-9" key={"feature" + idx}>
